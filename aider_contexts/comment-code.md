...
After understanding all the code and functions, you should create or update thorough, detailed, complete TSDoc comments for each exported function.
...
This code already contains some TSDoc sections created by aider, which already have the `@aider` tag. Do not create new sections for these, but review and update these doc comments as appropriate
