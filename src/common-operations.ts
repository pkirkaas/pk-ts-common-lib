 ...
 */
export function asEnumerable(obj: GenObj, depth = 6): GenObj {
 ...
 */
export function dbgReport(...args):string {
  let retArr=[];
  let idx=0;
...
export function keysToJson(arg: any): any {
  return keysToFromJson(arg, true);
}

export function keysFromJson(arg: any): any {
