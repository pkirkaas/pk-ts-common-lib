...
import { jsonClone, isEmpty, isSubset, arraysEqual, inArr1NinArr2, intersect, typeOf } from './index.js';
...
export class TagObj extends BaseTags{
	...
	tags: string[];
	tdata: any;
	constructor( tdata:any = null, tags?:any) {
		//@ts-ignore
		super(...arguments);
