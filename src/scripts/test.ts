import { filterInt,  deepMeld, uniqueVals, PkError, TagObj, TagObjCol, typeOf, isEmpty, jsondecycle, JSON5, isSubset, arraysEqual } from '../index.js';
 ...
 * @return int
 */
function randInt(to:any, from:any = 0) {
